...
class PlayerDefaultProperties {
    constructor(pongCanvasWidth, pongCanvasHeight, playerVelocityY = 0) {
...
class PlayerProperties {
    constructor(x, y, width, height, speedY, score = 0) {
        this._x = x;
        this._y = y;
        this._width = width;
        this._height = height;
...
class BallProperties {
    constructor(pongCanvasWidth, pongCanvasHeight, playerWidth, ballSpeed = 1, direction = 1) {
...
class PongData {
    constructor(pongCanvas, pongCanvasWidth = screen.width / 2, pongCanvasHeight = screen.height / 2, context) {
        ...
        this._ballProperties = new BallProperties(pongCanvasWidth, pongCanvasHeight, this._playerDefaultProperties._playerWidth);
        // init player1
        this._player1Properties = new PlayerProperties(this._pongCanvasWidth / 150, (this._pongCanvasHeight / 2) - (this._playerDefaultProperties._playerHeight / 2), this._playerDefaultProperties._playerWidth, this._playerDefaultProperties._playerHeight, this._playerDefaultProperties._playerVelocityY);
        // init player2
        this._player2Properties = new PlayerProperties(this._pongCanvasWidth - (this, this._pongCanvasWidth / 150) - this._playerDefaultProperties._playerWidth, (this._pongCanvasHeight / 2) - (this._playerDefaultProperties._playerHeight / 2), this._playerDefaultProperties._playerWidth, this._playerDefaultProperties._playerHeight, this._playerDefaultProperties._playerVelocityY);
    }
}
...
window.onload = function () {
    ...
    let pongData = new PongData(pongCanvas, pongCanvas.width, pongCanvas.height, context);
    if (pongData._context) {
        // draw player1
        pongData._context.fillStyle = "violet";
        pongData._context.fillRect(pongData._player1Properties._x, pongData._player1Properties._y, pongData._player1Properties._width, pongData._player1Properties._height);
        // draw player2
        pongData._context.fillStyle = "violet";
        pongData._context.fillRect(pongData._player2Properties._x, pongData._player2Properties._y, pongData._player2Properties._width, pongData._player2Properties._height);
    }
...
function update(pongData) {
    ...
    if (pongData._context) {
        ...
        pongData._context.fillRect(pongData._ballProperties._x, pongData._ballProperties._y, pongData._ballProperties._width, pongData._ballProperties._height);
        ...
        pongData._context.fillText(pongData._player1Properties._score.toString(), pongData._pongCanvasWidth / 4.3, pongData._pongCanvasHeight / 9);
        pongData._context.fillText(pongData._player2Properties._score.toString(), pongData._pongCanvasWidth * 4 / 5 - pongData._pongCanvasWidth / 15, pongData._pongCanvasHeight / 9);
        ...
        for (let i = pongData._pongCanvasHeight / 50; i < pongData._pongCanvasHeight; i += pongData._pongCanvasWidth / 30) {
            pongData._context.fillRect(pongData._pongCanvasWidth / 2 - ((pongData._pongCanvasWidth / 160) / 2), i, pongData._pongCanvasWidth / 160, pongData._pongCanvasWidth / 160);
        }
    }
}
...
function updateDirectionPlayer1(playerSegment, ball, pongdata) {
    let px;
    let py;
...
function updateDirectionPlayer2(playerSegment, ball, pongdata) {
    let px;
    let py;
    if (playerSegment === "top") {
        console.log("top");
...
function stopPlayer(e, pongData) {
    //player1
...
function movePlayer(e, pongData) {
    //player1
    if (e.code == "KeyW")
...
function checkPlayerBounds(nextPositionPlayerY, pongData) {
...
function checkBallCollision(ballPos, playerPos, pongData) {
...
function checkBallBoundsY(nextPositionBallY, pongData) {
    return (nextPositionBallY < 0 || nextPositionBallY > pongData._pongCanvasHeight);
}
function resetGame(direction, pongData) {
    pongData._ballProperties = new BallProperties(pongData._pongCanvasWidth, pongData._pongCanvasHeight, pongData._playerDefaultProperties._playerWidth, undefined, direction);
}
welcomeMessage();
